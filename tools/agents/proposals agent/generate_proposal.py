...
PROPOSALS    = SCRIPT_DIR / ".." / ".." / ".." / "operations" / "sales" / "proposals"
FONT_DIR     = SCRIPT_DIR / ".." / ".." / ".." / "sister" / "shared" / "Brand book" / "hebrew font" / "static"
...
class PageBuilder:
    ...
    def _draw_service_block(self, service: dict):
        ...
        if note:
            self._y -= 2
            self._draw_paragraph(note, font="Assistant-Bold", size=12, color=ORANGE)
