...
- קרא `../../shared knowledge/services.md`
...
- [ ] מחק קובץ ה-draft: `Remove-Item "proposals/proposal_[שם לקוח]_draft.json"`
...
| `Font not found` | ודא ש-`shared knowledge/Brand book/hebrew font/static/` קיים |
